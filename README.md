...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Prajeesh-A/numpy/blob/main/numpy.ipynb)
...
```bash
git clone https://github.com/Prajeesh-A/numpy.git
```
